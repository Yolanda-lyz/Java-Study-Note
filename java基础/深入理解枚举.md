...
![枚举-javac Operator类生成的字节码文件](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7baa9703699447b7a8b651f3a3e6a9cd~tplv-k3u1fbpfcp-watermark.image)

#### 2.1 javap Operator.class

使用javap Operator.class指令反编译枚举类型Operator，得到的信息如下：

![枚举-javap Operator.class](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/993f50ee493d456990cd272c8bd3056b~tplv-k3u1fbpfcp-watermark.image)
...
![枚举-javap_Operator$1](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/31fd2eb1ea9748d1bb921f072fcefe47~tplv-k3u1fbpfcp-watermark.image)
...
![枚举-Operator_InnerClasses](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c121de628ba94df49eb5054e31ebf9e8~tplv-k3u1fbpfcp-watermark.image)

#### 2.3 静态代码块字段

静态代码块字段的具体执行内容分析如下：

![枚举-静态代码块](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9d3eed635be34a95a7a84010091e87d3~tplv-k3u1fbpfcp-watermark.image)
...
![枚举-values](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fb5ef5092c5d4011a7b367b61d6a4222~tplv-k3u1fbpfcp-watermark.image)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6ef22b7f3dcc4bfbb3f0b5036be8f508~tplv-k3u1fbpfcp-watermark.image)
